...
The proposed standard builds on a strong foundation of existing open standards that make OpenET possible. We gratefully acknowledge the communities behind [OpenAPI](https://www.openapis.org/), [AsyncAPI](https://www.asyncapi.com/en), and [JSON Schema](https://json-schema.org/community), whose descriptive frameworks underpin this work.
...
👥 Participate in the OpenET [Working Group](https://forms.office.com/r/xJBF1P5d3p)

💬 Join [discussions](https://github.com/orgs/OpenET-Initiative/discussions) and share feedback

🛠️ Propose changes or improvements to the [specs](https://github.com/OpenET-Initiative/openet-spec/tree/main/docs/spec)
